...
document.addEventListener('DOMContentLoaded', () => {
    const tablesToLoad = [
        { tableId: "GriglieELivelli", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/ST02_08_00_GriglieLivelli.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('Monitor', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_08_01_CopyMonitorReport_Data.csv');
    loadCSV('NomenclaturaGriglieLivelli', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_08_02_GriglieELivelli_Data.csv');
    loadCSV('LivelliMEP', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_08_00_LivelliMEP.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_08_01_CopyMonitorReport_Data.csv',
        chartId: 'MonitorAsBarChart',
        statsId: 'Monitorstatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_08_02_GriglieELivelli_Data.csv',
        chartId: 'NomenclaturaGriglieLivelliAsBarChart',
        statsId: 'NomenclaturaGriglieLivellistatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_08_00_LivelliMEP.csv',
