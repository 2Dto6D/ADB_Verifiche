...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaInformativa", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Riepilogo/03/FA01_10_VerificaInformativa.csv" },
		{ tableId: "ProjectInfo", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/03/FA01_10_ProjectInfo.csv" },
		{ tableId: "ParametriIFC", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/03/FA01_10_ParametriIFC.csv" },
		{ tableId: "IFCEntity", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/03/FA01_10_IFCEntity.csv" },
	...
	loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/03/FA01_10_FaseErrata_Data.csv');
	loadCSV('ValorizzazioneIFC', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/03/FA01_10_ValorizzazioneIFCSaveAs_Data.csv');
	loadCSV('ParametriLOIN', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/03/FA01_10_ParametriLOIN.csv');
	loadCSV('ValoriParametriLOIN', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/03/FA01_10_ValoriParametriLOIN.csv');
	loadCSV('AssegnazioneMateriali', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/03/FA01_10_AssegnazioneMateriali.csv');

	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/03/FA01_10_FaseErrata_Data.csv',
		chartId: 'FaseErrataAsBarChart',
		statsId: 'FaseErrataStatistics',
		title: 'Istogramma delle Categorie'
	});
	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/03/FA01_10_ValorizzazioneIFCSaveAs_Data.csv',
	...
	const summaryConfigs = [
		{ statsId: "ParametriLOINstatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/03/FA01_10_ParametriLOIN.csv"},
		{ statsId: "ValoriParametriLOINstatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/03/FA01_10_ValoriParametriLOIN.csv"},
		{ statsId: "AssegnazioneMaterialistatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/03/FA01_10_AssegnazioneMateriali.csv"}
	];
