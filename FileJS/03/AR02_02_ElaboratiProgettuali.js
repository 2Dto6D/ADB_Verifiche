...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ElaboratiProgettuali", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Riepilogo/03/AR02_02_ElaboratiProgettuali.csv" },
		{ tableId: "CoerenzaEleborati", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Verifiche/03/AR02_02_CoerenzaElaborati.csv" }
	];
