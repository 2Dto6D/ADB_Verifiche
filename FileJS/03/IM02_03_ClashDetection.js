...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ClashDetection", repo:"2Dto6D/ADB_Verifiche", filePath:"IM02Riepilogo/03/IM02_03_ClashDetection.csv" },
		{ tableId: "Analisi", repo:"2Dto6D/ADB_Verifiche", filePath:"IM02Verifiche/03/IM02_03_Analisi.csv" }
	];
