...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "PGIEAllegati", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Riepilogo/03/AR02_01_pGIAllegati.csv" },
		{ tableId: "ReportPGI", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Verifiche/03/AR02_01_ReportPGI.csv" }
	];
