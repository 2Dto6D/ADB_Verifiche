...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ClashDetection", repo:"2Dto6D/ADB_Verifiche", filePath:"ST01Riepilogo/03/ST01_03_ClashDetection.csv" },
		{ tableId: "Analisi", repo:"2Dto6D/ADB_Verifiche", filePath:"ST01Verifiche/03/ST01_03_Analisi.csv" }
	];
