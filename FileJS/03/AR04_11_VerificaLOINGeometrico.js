...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"AR04Riepilogo/03/AR04_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/03/AR04_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'AR04Verifiche/03/AR04_11_ElementiLOIN.csv'
		}
	]
