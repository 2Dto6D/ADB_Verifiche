...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "GriglieELivelli", repo:"2Dto6D/ADB_Verifiche", filePath:"ST04Riepilogo/03/ST04_08_GriglieLivelli.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('NomenclaturaGriglieLivelli', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/03/ST04_08_NomenclaturaGriglieELivelli_Data.csv');
	loadCSV('LivelliMEP', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/03/ST04_08_VerificaPresenzaLivelliImpianti_Data.csv');

	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST04Verifiche/03/ST04_08_NomenclaturaGriglieELivelli_Data.csv',
		chartId: 'NomenclaturaGriglieLivelliAsBarChart',
		statsId: 'NomenclaturaGriglieLivelliStatistics',
		title: 'Istogramma delle Categorie'
	});
	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST04Verifiche/03/ST04_08_VerificaPresenzaLivelliImpianti_Data.csv',
