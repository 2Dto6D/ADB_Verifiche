...
document.addEventListener("DOMContentLoaded", function () {
    ...
    loadCSV('NomenclaturaMateriali', '2Dto6D/ADB_Verifiche', 'UR01Verifiche/UR01_12_00_NomenclaturaMateriali_Data.csv');
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'UR01Verifiche/UR01_12_00_FaseErrata_Data.csv');
    const tablesToLoad = [
        { tableId: "NamingConvention", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Riepilogo/UR01_12_00_NamingConvention.csv" }
    ];
    ...
    const chartsConfig = [
        ...
        },
        {
            ...
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'UR01Verifiche/UR01_12_00_NomenclaturaMateriali_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/UR01Verifiche/UR01_12_00_FaseErrata_Data.csv',
