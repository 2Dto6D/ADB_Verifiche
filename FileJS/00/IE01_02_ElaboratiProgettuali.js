...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ElaboratiProgettuali", repo: "2Dto6D/ADB_Verifiche", filePath: "IE01Riepilogo/00/IE01_02_ElaboratiProgettuali.csv" },
        { tableId: "CoerenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "IE01Verifiche/00/IE01_02_CoerenzaElaborati.csv" }
    ];
