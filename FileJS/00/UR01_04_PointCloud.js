...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "PointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Riepilogo/00/UR01_04_PointCloud.csv" },
        { tableId: "CoerenzaPointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_04_CoerenzaPointCloud.csv" }
    ];
