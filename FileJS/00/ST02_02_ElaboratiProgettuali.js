...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ElaboratiProgettuali", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/00/ST02_02_ElaboratiProgettuali.csv" },
        { tableId: "CoerenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/00/ST02_02_CoerenzaElaborati.csv" }
    ];
