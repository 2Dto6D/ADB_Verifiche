...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "PointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/00/FA01_04_PointCloud.csv" },
        { tableId: "CoerenzaPointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_04_CoerenzaPointCloud.csv" }
    ];
