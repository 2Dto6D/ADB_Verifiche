...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ElaboratiProgettuali", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Riepilogo/00/UR01_02_ElaboratiProgettuali.csv" },
        { tableId: "CoerenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_02_CoerenzaElaborati.csv" }
    ];
