...
document.addEventListener('DOMContentLoaded', () => {
    const tablesToLoad = [
        { tableId: "ACDat", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/00/FA01_05_ACDat.csv" },
        { tableId: "AperturaFile", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_05_AperturaFile.csv" },
        { tableId: "NomenclaturaFile", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_05_DimensioneNomenclaturaFile_Data.csv" },
        { tableId: "Documenti", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_05_Documenti.csv" },
        { tableId: "Report", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_05_Report.csv" }
    ];
