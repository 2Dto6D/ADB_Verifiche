...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "PointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Riepilogo/00/AR02_04_PointCloud.csv" },
        { tableId: "CoerenzaPointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Verifiche/00/AR02_04_CoerenzaPointCloud.csv" }
    ];
