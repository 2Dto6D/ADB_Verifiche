...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ElaboratiProgettuali", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Riepilogo/00/ST01_02_ElaboratiProgettuali.csv" },
        { tableId: "CoerenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Verifiche/00/ST01_02_CoerenzaElaborati.csv" }
    ];
