...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "UnitaDiMisura", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Riepilogo/00/ST01_15_UnitàMisura.csv" }
    ];
    ...
    loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_15_UnitaProgetto_Data.csv');
    const summaryConfigs = [
        { statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Verifiche/00/ST01_15_UnitaProgetto_Data.csv" }
    ];
