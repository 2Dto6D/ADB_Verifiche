...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "GeoreferenziazioneEOrientamento", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/00/ST02_07_Georeferenziazione.csv" },
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST02Verifiche/00/ST02_07_CoordinationReport_Data.csv', 'Coordination');
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST02Verifiche/00/ST02_07_LocationReport_Data.csv', 'LatLong');
});
