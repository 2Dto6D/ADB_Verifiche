...
document.addEventListener("DOMContentLoaded", function () {
    loadCSV('TipoCampo', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_12_NomenclaturaElementi.csv');
    loadCSV('NomenclaturaParametri', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_12_NomenclaturaParametri_Data.csv');
    loadCSV('NomenclaturaMateriali', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_12_NomenclaturaMateriali_Data.csv');
    loadCSV('NomenclaturaLocali', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_12_NomenclaturaLocali_Data.csv');
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/00/ST01_12_FaseErrata_Data.csv');
    const tablesToLoad = [
        { tableId: "NamingConvention", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Riepilogo/00/ST01_12_NamingConvention.csv" }
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ST01Verifiche/00/ST01_12_NomenclaturaElementi.csv'
        },
        {
            canvasId: 'NomenclaturaParametriGraficoATorta',
            statsId: 'NomenclaturaParametristatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST01Verifiche/00/ST01_12_NomenclaturaParametri_Data.csv'
        },
        {
            canvasId: 'NomenclaturaMaterialiGraficoATorta',
            statsId: 'NomenclaturaMaterialistatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST01Verifiche/00/ST01_12_NomenclaturaMateriali_Data.csv'
        },
        {
            canvasId: 'NomenclaturaLocaliGraficoATorta',
            statsId: 'NomenclaturaLocalistatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST01Verifiche/00/ST01_12_NomenclaturaLocali_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST01Verifiche/00/ST01_12_FaseErrata_Data.csv',
