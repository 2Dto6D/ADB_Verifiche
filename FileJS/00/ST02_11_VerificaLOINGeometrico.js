...
document.addEventListener('DOMContentLoaded', () => {
    const tablesToLoad = [
        { tableId: "VerificaLOINGeometrico", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/00/ST02_11_VerificaLOINGeometrico.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/00/ST02_11_ElementiLOIN.csv');
    const chartsConfig = [
        {
            canvasId: 'ElementiLOINGraficoATorta',
            statsId: 'ElementiLOINstatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST02Verifiche/00/ST02_11_ElementiLOIN.csv'
        }
    ];
