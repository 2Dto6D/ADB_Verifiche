...
document.addEventListener('DOMContentLoaded', () => {
    const tablesToLoad = [
        { tableId: "GriglieELivelli", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/00/FA01_08_GriglieLivelli.csv" },
        { tableId: "GrigliePGI", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_08_GrigliePGI.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('Monitor', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/00/FA01_08_CopyMonitorReport_Data.csv');
    loadCSV('NomenclaturaGriglieLivelli', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/00/FA01_08_GriglieELivelli_Data.csv');
    loadCSV('LivelliMEP', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/00/FA01_08_LivelliMEP.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/00/FA01_08_CopyMonitorReport_Data.csv',
        chartId: 'MonitorAsBarChart',
        statsId: 'Monitorstatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/00/FA01_08_GriglieELivelli_Data.csv',
        chartId: 'NomenclaturaGriglieLivelliAsBarChart',
        statsId: 'NomenclaturaGriglieLivellistatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/00/FA01_08_LivelliMEP.csv',
