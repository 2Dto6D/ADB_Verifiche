...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ElaboratiProgettuali", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Riepilogo/00/AR01_02_ElaboratiProgettuali.csv" },
        { tableId: "CoerenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Verifiche/00/AR01_02_CoerenzaElaborati.csv" }
    ];
