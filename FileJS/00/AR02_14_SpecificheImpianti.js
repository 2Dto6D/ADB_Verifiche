...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "SpecificheImpianti", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Riepilogo/00/AR02_14_SpecificheImpianti.csv" },
        { tableId: "AssegnazioneMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Verifiche/00/AR02_14_AssegnazioneMEP.csv" },
        { tableId: "CollegamentiMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Verifiche/00/AR02_14_CollegamentiMEP.csv" },
        { tableId: "CircuitiChiusi", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Verifiche/00/AR02_14_CircuitiChiusi.csv" },
        { tableId: "CategorieMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR02Verifiche/00/AR02_14_CategorieMEP.csv" }
    ];
