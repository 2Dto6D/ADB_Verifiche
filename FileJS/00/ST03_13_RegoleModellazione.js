...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "RegoleModellazione", repo: "2Dto6D/ADB_Verifiche", filePath: "ST03Riepilogo/00/ST03_13_RegoleModellazione.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('ElementOffset', '2Dto6D/ADB_Verifiche', 'ST03Verifiche/00/ST03_13_ElementOffset_Data.csv');
    loadCSV('StructuralError', '2Dto6D/ADB_Verifiche', 'ST03Verifiche/00/ST03_13_VincoloTraLivelli_Data.csv');
    loadCSV('VerificaLocali', '2Dto6D/ADB_Verifiche', 'ST03Verifiche/00/ST03_13_VerificaLocali_Data.csv');
    loadCSV('FamiglieInPlace', '2Dto6D/ADB_Verifiche', 'ST03Verifiche/00/ST03_13_FamiglieInPlace_Data.csv');
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ST03Verifiche/00/ST03_13_VerificaLocali_Data.csv'
        },
        {
            canvasId: 'FamiglieInPlaceGraficoATorta',
            statsId: 'FamiglieInPlacestatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST03Verifiche/00/ST03_13_FamiglieInPlace_Data.csv'
        }
    ];
