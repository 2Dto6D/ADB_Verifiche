...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "ClashDetection", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/00/ST02_03_ClashDetection.csv" },
        { tableId: "Analisi", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/00/ST02_03_Analisi.csv" }
    ];
