...
document.addEventListener("DOMContentLoaded", function () {
    loadCSV('ParametriCondivisi', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/00/FA01_09_SharedParameters_Data.csv');
    loadCSV('CorrispondenzaIFC', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/00/FA01_09_VerificaCorrispondenzaIFC.csv');
    const tablesToLoad = [
        { tableId: "IntegritàEPuliziaFile", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/00/FA01_09_PuliziaFile.csv" },
        { tableId: "PesoFile", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_200mb.csv" },
        { tableId: "VersioneFile", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_VersioneFile_Data.csv" },
        { tableId: "PresenzaElaborati", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_PresenzaElaborati.csv" },
        { tableId: "SovrapposizioniElementi", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_SovrapposizioniElementi.csv" },
        { tableId: "IFCMapping", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_IFCMapping.csv" },
        { tableId: "StartingView", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_StartingView_Data.csv" },
        { tableId: "LivelliInutilizzati", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_LivelliInutilizzati.csv" },
        { tableId: "BuildingElementProxy", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_BuildingElementProxy.csv" },
        { tableId: "Workset", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_PresenzaWorkset.csv" }
    ...
    const summaryConfigs = [
        { statsId: "ParametriCondivisistatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_SharedParameters_Data.csv" },
        { statsId: "CorrispondenzaIFCstatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/00/FA01_09_VerificaCorrispondenzaIFC.csv" }
    ];
