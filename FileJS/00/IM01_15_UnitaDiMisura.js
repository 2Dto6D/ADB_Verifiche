...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "UnitaDiMisura", repo: "2Dto6D/ADB_Verifiche", filePath: "IM01Riepilogo/00/IM01_15_UnitàMisura.csv" }
    ];
    ...
    loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'IM01Verifiche/00/IM01_15_UnitaProgetto_Data.csv');
    const summaryConfigs = [
        { statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "IM01Verifiche/00/IM01_15_UnitaProgetto_Data.csv" }
    ];
