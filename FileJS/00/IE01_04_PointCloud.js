...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "PointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "IE01Riepilogo/00/IE01_04_PointCloud.csv" },
        { tableId: "CoerenzaPointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "IE01Verifiche/00/IE01_04_CoerenzaPointCloud.csv" }
    ];
