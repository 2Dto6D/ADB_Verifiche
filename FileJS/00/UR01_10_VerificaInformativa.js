...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "VerificaInformativa", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Riepilogo/00/UR01_10_VerificaInformativa.csv" },
        { tableId: "ProjectInfo", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_ProjectInfo.csv" },
        { tableId: "ParametriIFC", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_ParametriIFC.csv" },
        { tableId: "IFCEntity", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_IFCEntity.csv" },
        { tableId: "ParametriLOIN", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_ParametriLOIN.csv" },
        { tableId: "ValoriParametriLOIN", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_ValoriParametriLOIN.csv" },
        { tableId: "AssegnazioneMateriali", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_10_AssegnazioneMateriali.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'UR01Verifiche/00/UR01_10_FaseErrata_Data.csv');
    loadCSV('ValorizzazioneIFC', '2Dto6D/ADB_Verifiche', 'UR01Verifiche/00/UR01_10_ValorizzazioneIFCSaveAs_Data.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/UR01Verifiche/00/UR01_10_FaseErrata_Data.csv',
        chartId: 'FaseErrataAsBarChart',
        statsId: 'FaseErratastatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/UR01Verifiche/00/UR01_10_ValorizzazioneIFCSaveAs_Data.csv',
