...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "GeoreferenziazioneEOrientamento", repo: "2Dto6D/ADB_Verifiche", filePath: "IE01Riepilogo/00/IE01_07_Georeferenziazione.csv" },
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IE01Verifiche/00/IE01_07_CoordinationReport_Data.csv', 'Coordination');
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IE01Verifiche/00/IE01_07_LocationReport_Data.csv', 'LatLong');
});
