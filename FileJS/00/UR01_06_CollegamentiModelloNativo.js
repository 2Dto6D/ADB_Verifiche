...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "CollegamentiModelloNativo", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Riepilogo/00/UR01_06_ModelloNativo.csv" },
        { tableId: "FileCollegati", repo: "2Dto6D/ADB_Verifiche", filePath: "UR01Verifiche/00/UR01_06_FileCollegati.csv" }
    ];
