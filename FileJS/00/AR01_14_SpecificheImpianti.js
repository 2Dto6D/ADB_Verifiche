...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "SpecificheImpianti", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Riepilogo/00/AR01_14_SpecificheImpianti.csv" },
        { tableId: "AssegnazioneMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Verifiche/00/AR01_14_AssegnazioneMEP.csv" },
        { tableId: "CollegamentiMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Verifiche/00/AR01_14_CollegamentiMEP.csv" },
        { tableId: "CircuitiChiusi", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Verifiche/00/AR01_14_CircuitiChiusi.csv" },
        { tableId: "CategorieMEP", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Verifiche/00/AR01_14_CategorieMEP.csv" }
    ];
