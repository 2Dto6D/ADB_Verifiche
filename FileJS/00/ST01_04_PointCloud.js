...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "PointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Riepilogo/00/ST01_04_PointCloud.csv" },
        { tableId: "CoerenzaPointCloud", repo: "2Dto6D/ADB_Verifiche", filePath: "ST01Verifiche/00/ST01_04_CoerenzaPointCloud.csv" }
    ];
