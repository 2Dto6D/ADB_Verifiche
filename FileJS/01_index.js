...
document.addEventListener("DOMContentLoaded", function () {
    loadCSVIndex('2Dto6D/ADB_Verifiche', 'FileCSVindex/01/00_Verifiche.csv', 'VerificheGenerali');
    const tablesToLoad = [
        { tableId: "Dati", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/01/00_DatiGenerali.csv" },
        { tableId: "LineeGuida", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/01/00_Cluster.csv" },
        { tableId: "Modalita", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/01/00_Modalita.csv" }
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'FileCSVindex/01/00_Verifiche.csv'
        }
    ];
