...
document.addEventListener("DOMContentLoaded", function () {
    loadCSVIndex('2Dto6D/ADB_Verifiche', 'FileCSVindex/00_00_Verifiche.csv', 'VerificheGenerali');
    const tablesToLoad = [
        { tableId: "Dati", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/00_00_DatiGenerali.csv" },
        { tableId: "LineeGuida", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/00_00_Cluster.csv" },
        { tableId: "Modalita", repo: "2Dto6D/ADB_Verifiche", filePath: "FileCSVindex/00_00_Modalita.csv" }
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'FileCSVindex/00_00_Verifiche.csv'
        }
    ];
