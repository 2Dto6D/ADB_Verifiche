...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "UnitaDiMisura", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/ST02_15_00_UnitàMisura.csv" }
    ];
    ...
    loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_15_01_UnitaProgetto_Data.csv');
    const summaryConfigs = [
        { statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/ST02_15_01_UnitaProgetto_Data.csv" }
    ];
