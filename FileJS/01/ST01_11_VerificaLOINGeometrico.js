...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"ST01Riepilogo/01/ST01_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'ST01Verifiche/01/ST01_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'ST01Verifiche/01/ST01_11_ElementiLOIN.csv'
		}
	]
