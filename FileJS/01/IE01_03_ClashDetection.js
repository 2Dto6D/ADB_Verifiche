...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ClashDetection", repo:"2Dto6D/ADB_Verifiche", filePath:"IE01Riepilogo/01/IE01_03_ClashDetection.csv" },
		{ tableId: "Analisi", repo:"2Dto6D/ADB_Verifiche", filePath:"IE01Verifiche/01/IE01_03_Analisi.csv" }
	];
