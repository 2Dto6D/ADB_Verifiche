...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"IE01Riepilogo/01/IE01_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'IE01Verifiche/01/IE01_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'IE01Verifiche/01/IE01_11_ElementiLOIN.csv'
		}
	]
