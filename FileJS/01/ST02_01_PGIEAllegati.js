...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "PGIEAllegati", repo:"2Dto6D/ADB_Verifiche", filePath:"ST02Riepilogo/01/ST02_01_pGIAllegati.csv" },
		{ tableId: "ReportPGI", repo:"2Dto6D/ADB_Verifiche", filePath:"ST02Verifiche/01/ST02_01_ReportPGI.csv" }
	];
