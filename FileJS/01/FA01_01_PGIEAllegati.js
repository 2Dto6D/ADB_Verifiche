...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "PGIEAllegati", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Riepilogo/01/FA01_01_pGIAllegati.csv" },
		{ tableId: "ReportPGI", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/01/FA01_01_ReportPGI.csv" }
	];
