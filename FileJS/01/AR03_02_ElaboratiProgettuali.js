...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ElaboratiProgettuali", repo:"2Dto6D/ADB_Verifiche", filePath:"AR03Riepilogo/01/AR03_02_ElaboratiProgettuali.csv" },
		{ tableId: "CoerenzaEleborati", repo:"2Dto6D/ADB_Verifiche", filePath:"AR03Verifiche/01/AR03_02_CoerenzaElaborati.csv" }
	];
