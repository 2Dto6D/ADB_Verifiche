...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "NamingConvention", repo:"2Dto6D/ADB_Verifiche", filePath:"AR04Riepilogo/01/AR04_12_NamingConvention.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('TipoCampo', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/01/AR04_12_NomenclaturaElementi.csv');
	loadCSV('NomenclaturaParametri', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/01/AR04_12_NomenclaturaParametri_Data.csv');
	loadCSV('NomenclaturaMateriali', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/01/AR04_12_NomenclaturaMateriali_Data.csv');
	loadCSV('NomenclaturaLocali', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/01/AR04_12_NomenclaturaLocali_Data.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'AR04Verifiche/01/AR04_12_NomenclaturaElementi.csv'
		},
		{
			canvasId: 'NomenclaturaParametriGraficoATorta',
			statsId: 'NomenclaturaParametristatistics',
			repo: '2Dto6D/ADB_Verifiche',
			filePath: 'AR04Verifiche/01/AR04_12_NomenclaturaParametri_Data.csv'
		},
		{
			canvasId: 'NomenclaturaMaterialiGraficoATorta',
			statsId: 'NomenclaturaMaterialistatistics',
			repo: '2Dto6D/ADB_Verifiche',
			filePath: 'AR04Verifiche/01/AR04_12_NomenclaturaMateriali_Data.csv'
		},
		{
			canvasId: 'NomenclaturaLocaliGraficoATorta',
			statsId: 'NomenclaturaLocalistatistics',
			repo: '2Dto6D/ADB_Verifiche',
			filePath: 'AR04Verifiche/01/AR04_12_NomenclaturaLocali_Data.csv'
		}
	]
