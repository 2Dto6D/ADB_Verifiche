...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        ...
        { tableId: "IFCEntity", repo: "2Dto6D/ADB_Verifiche", filePath: "IM01Verifiche/IM01_10_00_IFCEntity.csv" },
        { tableId: "AssegnazioneMateriali", repo: "2Dto6D/ADB_Verifiche", filePath: "IM01Verifiche/IM01_10_00_AssegnazioneMateriali.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'IM01Verifiche/IM01_10_00_FaseErrata_Data.csv');
    loadCSV('ValorizzazioneIFC', '2Dto6D/ADB_Verifiche', 'IM01Verifiche/IM01_10_00_ValorizzazioneIFCSaveAs_Data.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/IM01Verifiche/IM01_10_00_FaseErrata_Data.csv',
        chartId: 'FaseErrataAsBarChart',
        statsId: 'FaseErratastatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/IM01Verifiche/IM01_10_00_ValorizzazioneIFCSaveAs_Data.csv',
