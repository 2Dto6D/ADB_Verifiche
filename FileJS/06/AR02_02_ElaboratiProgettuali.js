...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ElaboratiProgettuali", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Riepilogo/06/AR02_02_ElaboratiProgettuali.csv" },
		{ tableId: "CoerenzaEleborati", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Verifiche/06/AR02_02_CoerenzaElaborati.csv" }
	];
