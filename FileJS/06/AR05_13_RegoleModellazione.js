...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "RegoleModellazione", repo:"2Dto6D/ADB_Verifiche", filePath:"AR05Riepilogo/06/AR05_13_RegoleModellazione.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementOffset', '2Dto6D/ADB_Verifiche', 'AR05Verifiche/06/AR05_13_ElementOffset_Data.csv');
	loadCSV('VerificaLocali', '2Dto6D/ADB_Verifiche', 'AR05Verifiche/06/AR05_13_VerificaLocali_Data.csv');

	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/AR05Verifiche/06/AR05_13_ElementOffset_Data.csv',
	...
	const chartsConfig = [
		{
			...
			filePath: 'AR05Verifiche/06/AR05_13_VerificaLocali_Data.csv'
		}
	]
