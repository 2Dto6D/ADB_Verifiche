...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "PGIEAllegati", repo:"2Dto6D/ADB_Verifiche", filePath:"UR01Riepilogo/06/UR01_01_pGIAllegati.csv" },
		{ tableId: "ReportPGI", repo:"2Dto6D/ADB_Verifiche", filePath:"UR01Verifiche/06/UR01_01_ReportPGI.csv" }
	];
