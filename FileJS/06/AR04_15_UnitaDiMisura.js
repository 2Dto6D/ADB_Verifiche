...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "UnitaDiMisura", repo:"2Dto6D/ADB_Verifiche", filePath:"AR04Riepilogo/06/AR04_15_UnitàMisura.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'AR04Verifiche/06/AR04_15_UnitaProgetto_Data.csv');



	const summaryConfigs = [
		{ statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "AR04Verifiche/06/AR04_15_UnitaProgetto_Data.csv"}
	];
