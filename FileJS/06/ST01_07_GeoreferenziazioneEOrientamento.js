...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "GeoreferenziazioneEOrientamento", repo:"2Dto6D/ADB_Verifiche", filePath:"ST01Riepilogo/06/ST01_07_Georeferenziazione.csv" }
	];
	...
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST01Verifiche/06/ST01_07_CoordinationLatLong_Data.csv', 'LatLong');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST01Verifiche/06/ST01_07_CoordinationElevation_Data.csv', 'Coordination');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST01Verifiche/06/ST01_07_CoordinationNSEW_Data.csv', 'CoordinateCondivise');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'ST01Verifiche/06/ST01_07_CoordinationTrueNorth_Data.csv', 'NordReale');
