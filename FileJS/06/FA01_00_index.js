...
document.addEventListener("DOMContentLoaded", function () {
    loadCSVIndex('2Dto6D/ADB_Verifiche', 'ADB01index/06/FA01_Verifiche.csv', 'Verifiche');
    const tablesToLoad = [
        { tableId: "Dati", repo: "2Dto6D/ADB_Verifiche", filePath: "ADB01index/06/FA01_DatiGenerali.csv" },
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ADB01index/06/FA01_Verifiche.csv'
        }
    ];
