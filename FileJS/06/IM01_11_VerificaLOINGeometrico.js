...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"IM01Riepilogo/06/IM01_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'IM01Verifiche/06/IM01_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'IM01Verifiche/06/IM01_11_ElementiLOIN.csv'
		}
	]
