...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "UnitaDiMisura", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Riepilogo/06/FA01_15_UnitàMisura.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/06/FA01_15_UnitaProgetto_Data.csv');



	const summaryConfigs = [
		{ statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/06/FA01_15_UnitaProgetto_Data.csv"}
	];
