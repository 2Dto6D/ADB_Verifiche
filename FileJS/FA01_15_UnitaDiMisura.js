...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "UnitaDiMisura", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/FA01_15_00_UnitàMisura.csv" }
    ];
    ...
    loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/FA01_15_01_UnitaProgetto_Data.csv');
    const summaryConfigs = [
        { statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Verifiche/FA01_15_01_UnitaProgetto_Data.csv" }
    ];
