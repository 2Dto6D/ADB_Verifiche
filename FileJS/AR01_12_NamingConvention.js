...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const tablesToLoad = [
        { tableId: "NamingConvention", repo: "2Dto6D/ADB_Verifiche", filePath: "AR01Riepilogo/AR01_12_00_NamingConvention.csv" }
    ];
    ...
    const chartsConfig = [
        ...
        },
        {
            ...
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'AR01Verifiche/AR01_12_00_NomenclaturaMateriali_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/AR01Verifiche/AR01_12_00_FaseErrata_Data.csv',
