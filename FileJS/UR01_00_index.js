...
document.addEventListener("DOMContentLoaded", function () {
    loadCSVIndex('2Dto6D/ADB_Verifiche', 'ADB01index/UR01_00_Verifiche.csv', 'Verifiche');
    const tablesToLoad = [
        { tableId: "Dati", repo: "2Dto6D/ADB_Verifiche", filePath: "ADB01index/UR01_00_DatiGenerali.csv" },
    ];
