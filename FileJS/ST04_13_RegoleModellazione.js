...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "RegoleModellazione", repo: "2Dto6D/ADB_Verifiche", filePath: "ST04Riepilogo/02/ST04_13_RegoleModellazione.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('ElementOffset', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/02/ST04_13_ElementOffset_Data.csv');
    loadCSV('StructuralError', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/02/ST04_13_VincoloTraLivelli_Data.csv');
    loadCSV('VerificaLocali', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/02/ST04_13_VerificaLocali_Data.csv');
    loadCSV('FamiglieInPlace', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/02/ST04_13_FamiglieInPlace_Data.csv');
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ST04Verifiche/02/ST04_13_VincoloTraLivelli_Data.csv'
        },
        {
            canvasId: 'VerificaLocaliGraficoATorta',
            statsId: 'VerificaLocalistatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST04Verifiche/02/ST04_13_VerificaLocali_Data.csv'
        },
        {
            canvasId: 'FamiglieInPlaceGraficoATorta',
            statsId: 'FamiglieInPlacestatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST04Verifiche/02/ST04_13_FamiglieInPlace_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST04Verifiche/02/ST04_13_ElementOffset_Data.csv',
