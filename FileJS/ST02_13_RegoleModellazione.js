...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "RegoleModellazione", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/ST02_13_00_RegoleModellazione.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('StructuralError', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_13_00_VincoloTraLivelli_Data.csv');
    loadCSV('VerificaLocali', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_13_00_VerificaLocali_Data.csv');
    loadCSV('ElementOffset', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_13_00_ElementOffset_Data.csv');
    loadCSV('FamiglieInPlace', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_13_00_FamiglieInPlace_Data.csv');
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ST02Verifiche/ST02_13_00_VincoloTraLivelli_Data.csv'
        },
        {
            canvasId: 'VerificaLocaliGraficoATorta',
            statsId: 'VerificaLocalistatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST02Verifiche/ST02_13_00_VerificaLocali_Data.csv'
        },
        {
            canvasId: 'FamiglieInPlaceGraficoATorta',
            statsId: 'FamiglieInPlacestatistics',
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'ST02Verifiche/ST02_13_00_FamiglieInPlace_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_13_00_ElementOffset_Data.csv',
