...
document.addEventListener("DOMContentLoaded", function () {
    loadCSV('TipoCampo', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/FA01_12_00_NomenclaturaElementi.csv');
    loadCSV('NomenclaturaParametri', '2Dto6D/ADB_Verifiche', '');
    loadCSV('NomenclaturaMateriali', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/FA01_12_00_NomenclaturaMateriali_Data.csv');
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'FA01Verifiche/FA01_12_00_FaseErrata_Data.csv');
    const tablesToLoad = [
        { tableId: "NamingConvention", repo: "2Dto6D/ADB_Verifiche", filePath: "FA01Riepilogo/FA01_12_00_NamingConvention.csv" }
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'FA01Verifiche/FA01_12_00_NomenclaturaElementi.csv'
        },
        {
        ...
        },
        {
            ...
            repo: '2Dto6D/ADB_Verifiche',
            filePath: 'FA01Verifiche/FA01_12_00_NomenclaturaMateriali_Data.csv'
        }
    ];
    ...
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/FA01Verifiche/FA01_12_00_FaseErrata_Data.csv',
