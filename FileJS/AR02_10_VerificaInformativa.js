...
document.addEventListener("DOMContentLoaded", function () {
    ...
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'AR02Verifiche/AR02_10_00_FaseErrata_Data.csv');
    loadCSV('ValorizzazioneIFC', '2Dto6D/ADB_Verifiche', 'AR02Verifiche/AR02_10_00_ValorizzazioneIFCSaveAs_Data.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/AR02Verifiche/AR02_10_00_FaseErrata_Data.csv',
        chartId: 'FaseErrataAsBarChart',
        statsId: 'FaseErratastatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/AR02Verifiche/AR02_10_00_ValorizzazioneIFCSaveAs_Data.csv',
