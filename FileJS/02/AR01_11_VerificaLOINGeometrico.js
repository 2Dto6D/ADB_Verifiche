...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"AR01Riepilogo/02/AR01_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'AR01Verifiche/02/AR01_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'AR01Verifiche/02/AR01_11_ElementiLOIN.csv'
		}
	]
