...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ElaboratiProgettuali", repo:"2Dto6D/ADB_Verifiche", filePath:"ST02Riepilogo/02/ST02_02_ElaboratiProgettuali.csv" },
		{ tableId: "CoerenzaEleborati", repo:"2Dto6D/ADB_Verifiche", filePath:"ST02Verifiche/02/ST02_02_CoerenzaElaborati.csv" }
	];
