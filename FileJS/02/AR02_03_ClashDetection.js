...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ClashDetection", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Riepilogo/02/AR02_03_ClashDetection.csv" },
		{ tableId: "Analisi", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Verifiche/02/AR02_03_Analisi.csv" }
	];
