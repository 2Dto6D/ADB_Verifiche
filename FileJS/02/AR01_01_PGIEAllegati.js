...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "PGIEAllegati", repo:"2Dto6D/ADB_Verifiche", filePath:"AR01Riepilogo/02/AR01_01_pGIAllegati.csv" },
		{ tableId: "ReportPGI", repo:"2Dto6D/ADB_Verifiche", filePath:"AR01Verifiche/02/AR01_01_ReportPGI.csv" }
	];
