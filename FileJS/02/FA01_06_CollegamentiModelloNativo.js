...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "CollegamentiModelloNativo", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Riepilogo/02/FA01_06_ModelloNativo.csv" },
		{ tableId: "FileCollegati", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/02/FA01_06_FileCollegati.csv" }
	];
