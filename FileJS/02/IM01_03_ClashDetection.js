...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ClashDetection", repo:"2Dto6D/ADB_Verifiche", filePath:"IM01Riepilogo/02/IM01_03_ClashDetection.csv" },
		{ tableId: "Analisi", repo:"2Dto6D/ADB_Verifiche", filePath:"IM01Verifiche/02/IM01_03_Analisi.csv" }
	];
