...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "UnitaDiMisura", repo:"2Dto6D/ADB_Verifiche", filePath:"IM02Riepilogo/02/IM02_15_UnitàMisura.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('UnitaProgetto', '2Dto6D/ADB_Verifiche', 'IM02Verifiche/02/IM02_15_UnitaProgetto_Data.csv');



	const summaryConfigs = [
		{ statsId: "UnitaProgettostatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "IM02Verifiche/02/IM02_15_UnitaProgetto_Data.csv"}
	];
