...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "RegoleModellazione", repo:"2Dto6D/ADB_Verifiche", filePath:"IE01Riepilogo/02/IE01_13_RegoleModellazione.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementOffset', '2Dto6D/ADB_Verifiche', 'IE01Verifiche/02/IE01_13_ElementOffset_Data.csv');
	loadCSV('VerificaLocali', '2Dto6D/ADB_Verifiche', 'IE01Verifiche/02/IE01_13_VerificaLocali_Data.csv');

	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/IE01Verifiche/02/IE01_13_ElementOffset_Data.csv',
	...
	const chartsConfig = [
		{
			...
			filePath: 'IE01Verifiche/02/IE01_13_VerificaLocali_Data.csv'
		}
	]
