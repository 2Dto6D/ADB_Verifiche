...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "VerificaInformativa", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Riepilogo/ST02_10_00_VerificaInformativa.csv" },
        { tableId: "ProjectInfo", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/ST02_10_00_ProjectInfo.csv" },
        { tableId: "IFCEntity", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/ST02_10_00_IFCEntity.csv" },
        { tableId: "AssegnazioneMateriali", repo: "2Dto6D/ADB_Verifiche", filePath: "ST02Verifiche/ST02_10_00_AssegnazioneMateriali.csv" }
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSV('FaseErrata', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_10_00_FaseErrata_Data.csv');
    loadCSV('ValorizzazioneIFC', '2Dto6D/ADB_Verifiche', 'ST02Verifiche/ST02_10_00_ValorizzazioneIFCSaveAs_Data.csv');
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_10_00_FaseErrata_Data.csv',
        chartId: 'FaseErrataAsBarChart',
        statsId: 'FaseErratastatistics',
        title: 'Istogramma delle Categorie'
    });
    loadHistogramFromCSV({
        csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST02Verifiche/ST02_10_00_ValorizzazioneIFCSaveAs_Data.csv',
