...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "GeoreferenziazioneEOrientamento", repo:"2Dto6D/ADB_Verifiche", filePath:"IM02Riepilogo/04/IM02_07_Georeferenziazione.csv" }
	];
	...
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM02Verifiche/04/IM02_07_CoordinationLatLong_Data.csv', 'LatLong');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM02Verifiche/04/IM02_07_CoordinationElevation_Data.csv', 'Coordination');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM02Verifiche/04/IM02_07_CoordinationNSEW_Data.csv', 'CoordinateCondivise');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM02Verifiche/04/IM02_07_CoordinationTrueNorth_Data.csv', 'NordReale');
