...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "IntegritàEPuliziaFile", repo:"2Dto6D/ADB_Verifiche", filePath:"ST04Riepilogo/04/ST04_09_PuliziaFile.csv" },
		{ tableId: "PesoFile", repo:"2Dto6D/ADB_Verifiche", filePath:"ST04Verifiche/04/ST04_09_DimensioneFiles_Data.csv" },
		{ tableId: "VersioneFile", repo:"2Dto6D/ADB_Verifiche", filePath:"ST04Verifiche/04/ST04_09_VersioneFiles_Data.csv" },
		{ tableId: "IFCMapping", repo:"2Dto6D/ADB_Verifiche", filePath:"ST04Verifiche/04/ST04_09_IFCMapping_Data.csv" },
	...
	loadCSV('SovrapposizioneElementi', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/04/ST04_09_SovrapposizioniElementi_Data.csv');
	loadCSV('LivelliInutilizzati', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/04/ST04_09_LivelliInutilizzati_Data.csv');
	loadCSV('BuildingElementProxy', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/04/ST04_09_BuildingElementProxy_Data.csv');
	loadCSV('ParametriCondivisi', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/04/ST04_09_SharedParameters_Data.csv');
	loadCSV('CorrispondenzaIFC', '2Dto6D/ADB_Verifiche', 'ST04Verifiche/04/ST04_09_VerificaCorrispondenzaIFC_Data.csv');

	loadHistogramFromCSV({
		csvUrl: 'https://raw.githubusercontent.com/2Dto6D/ADB_Verifiche/main/ST04Verifiche/04/ST04_09_SovrapposizioniElementi_Data.csv',
	...
	const summaryConfigs = [
		{ statsId: "LivelliInutilizzatistatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST04Verifiche/04/ST04_09_LivelliInutilizzati_Data.csv"},
		{ statsId: "BuildingElementProxystatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST04Verifiche/04/ST04_09_BuildingElementProxy_Data.csv"},
		{ statsId: "ParametriCondivisistatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST04Verifiche/04/ST04_09_SharedParameters_Data.csv"},
		{ statsId: "CorrispondenzaIFCstatistics", repo: "2Dto6D/ADB_Verifiche", filePath: "ST04Verifiche/04/ST04_09_VerificaCorrispondenzaIFC_Data.csv"}
	];
