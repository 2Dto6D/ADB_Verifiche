...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "GeoreferenziazioneEOrientamento", repo:"2Dto6D/ADB_Verifiche", filePath:"AR02Riepilogo/04/AR02_07_Georeferenziazione.csv" }
	];
	...
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'AR02Verifiche/04/AR02_07_CoordinationLatLong_Data.csv', 'LatLong');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'AR02Verifiche/04/AR02_07_CoordinationElevation_Data.csv', 'Coordination');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'AR02Verifiche/04/AR02_07_CoordinationNSEW_Data.csv', 'CoordinateCondivise');
	loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'AR02Verifiche/04/AR02_07_CoordinationTrueNorth_Data.csv', 'NordReale');
