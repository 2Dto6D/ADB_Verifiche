...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "VerificaLOINGeometrico", repo:"2Dto6D/ADB_Verifiche", filePath:"UR01Riepilogo/04/UR01_11_VerificaLOINGeometrico.csv" }
	];
	tablesToLoad.forEach(table => {
		loadCSVToTable(table.tableId, table.repo, table.filePath);
	});
	loadCSV('ElementiLOIN', '2Dto6D/ADB_Verifiche', 'UR01Verifiche/04/UR01_11_ElementiLOIN.csv');
	...
	const chartsConfig = [
		{
			...
			filePath: 'UR01Verifiche/04/UR01_11_ElementiLOIN.csv'
		}
	]
