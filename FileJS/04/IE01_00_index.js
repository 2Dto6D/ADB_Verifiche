...
document.addEventListener("DOMContentLoaded", function () {
    loadCSVIndex('2Dto6D/ADB_Verifiche', 'ADB01index/04/IE01_Verifiche.csv', 'Verifiche');
    const tablesToLoad = [
        { tableId: "Dati", repo: "2Dto6D/ADB_Verifiche", filePath: "ADB01index/04/IE01_DatiGenerali.csv" },
    ];
    ...
    const chartsConfig = [
        {
            ...
            filePath: 'ADB01index/04/IE01_Verifiche.csv'
        }
    ];
