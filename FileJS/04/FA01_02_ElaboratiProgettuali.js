...
document.addEventListener("DOMContentLoaded", function () {
	const tablesToLoad = [
		{ tableId: "ElaboratiProgettuali", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Riepilogo/04/FA01_02_ElaboratiProgettuali.csv" },
		{ tableId: "CoerenzaEleborati", repo:"2Dto6D/ADB_Verifiche", filePath:"FA01Verifiche/04/FA01_02_CoerenzaElaborati.csv" }
	];
