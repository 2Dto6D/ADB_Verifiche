...
document.addEventListener("DOMContentLoaded", function () {
    const tablesToLoad = [
        { tableId: "GeoreferenziazioneEOrientamento", repo: "2Dto6D/ADB_Verifiche", filePath: "IM01Riepilogo/IM01_07_00_Georeferenziazione.csv" },
    ];

    tablesToLoad.forEach(table => {
        loadCSVToTable(table.tableId, table.repo, table.filePath);
    });
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM01Verifiche/IM01_07_01_CoordinationReport_Data.csv', 'Coordination');
    loadCSVToTableEsito('2Dto6D/ADB_Verifiche', 'IM01Verifiche/IM01_07_02_LocationReport_Data.csv', 'LatLong');
});
